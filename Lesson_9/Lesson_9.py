...
if __name__ == '__main__':
 hosts = ['192.168.88.1', '192.168.88.254', 'google.com', 'mail.ru']

 print(host_ping(hosts))
 print(host_range_ping('192.168.88.1', '192.168.88.30'))
 print(host_range_ping_tab('192.168.88.1', '192.168.88.20'))